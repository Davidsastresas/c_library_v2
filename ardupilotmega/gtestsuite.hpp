...
TEST(ardupilotmega, ARYS_ACC)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::ARYS_ACC packet_in{};
    packet_in.grndacc = 17.0;
    packet_in.arspdacc = 45.0;

    mavlink::ardupilotmega::msg::ARYS_ACC packet1{};
    mavlink::ardupilotmega::msg::ARYS_ACC packet2{};
    ...
    EXPECT_EQ(packet1.grndacc, packet2.grndacc);
    EXPECT_EQ(packet1.arspdacc, packet2.arspdacc);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, ARYS_ACC)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_arys_acc_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.grndacc, packet2.grndacc);
    EXPECT_EQ(packet_in.arspdacc, packet2.arspdacc);
...
TEST(ardupilotmega, AR_EFI_TELEMETRY)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::AR_EFI_TELEMETRY packet_in{};
    packet_in.coolant = 17859;
    packet_in.rpm = 17963;
    packet_in.barometer = 18067;
    packet_in.tps = 18171;
    packet_in.batteryVoltage = 18275;
    packet_in.fuel_instant = 17.0;
    packet_in.fuel_consumed = 45.0;
    packet_in.fuel_remaining = 73.0;

    mavlink::ardupilotmega::msg::AR_EFI_TELEMETRY packet1{};
    mavlink::ardupilotmega::msg::AR_EFI_TELEMETRY packet2{};
    ...
    EXPECT_EQ(packet1.batteryVoltage, packet2.batteryVoltage);
    EXPECT_EQ(packet1.fuel_instant, packet2.fuel_instant);
    EXPECT_EQ(packet1.fuel_consumed, packet2.fuel_consumed);
    EXPECT_EQ(packet1.fuel_remaining, packet2.fuel_remaining);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, AR_EFI_TELEMETRY)
{
    mavlink_message_t msg;
    ...
    mavlink_ar_efi_telemetry_t packet_c {
    ...
    mavlink_msg_ar_efi_telemetry_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.batteryVoltage, packet2.batteryVoltage);
    EXPECT_EQ(packet_in.fuel_instant, packet2.fuel_instant);
    EXPECT_EQ(packet_in.fuel_consumed, packet2.fuel_consumed);
    EXPECT_EQ(packet_in.fuel_remaining, packet2.fuel_remaining);
