...
TEST(ardupilotmega, ERM_TRACKER)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::ERM_TRACKER packet_in{};
    packet_in.Status = 29;
    packet_in.x0 = 17235;
    packet_in.x1 = 17339;
    packet_in.y0 = 17443;
    ...
    mavlink::ardupilotmega::msg::ERM_TRACKER packet1{};
    mavlink::ardupilotmega::msg::ERM_TRACKER packet2{};
...
#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, ERM_TRACKER)
{
    mavlink_message_t msg;
    ...
    mavlink_erm_tracker_t packet_c {
    ...
    mavlink_msg_erm_tracker_encode(1, 1, &msg, &packet_c);
