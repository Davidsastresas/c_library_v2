...
enum class MAV_CMD
{
    ...
    WHEEL_BRAKE=41000, /* Activate/deactivate wheel brakes. |1 activate, 0 deactivate.| Empty,| Empty.| Empty.| Empty.| Empty.| Empty.|  */
    FLAP_ACTION=41001, /* Flap action, for flap_auto configured servos. |3 auto flap, 0 flaps retracted, 1 first flap position, 2 second flap position| Empty,| Empty.| Empty.| Empty.| Empty.| Empty.|  */
...
#include "./mavlink_msg_arys_acc.hpp"
#include "./mavlink_msg_ar_efi_telemetry.hpp"
#include "./mavlink_msg_ar_adc.hpp"
